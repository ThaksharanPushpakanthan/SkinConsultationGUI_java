...
public class ConsultationGUI extends JFrame {
    ...
    ConsultationGUI() {
        ...
        textFieldForFName.setBounds(757, 150, 200, 40);
        ...
        forSurName.setBounds(985, 150, 100, 35);
        forSurName.setFont(new Font("MV Boli", Font.PLAIN, 18));

        labelFieldForDOB = new JLabel();
        labelFieldForDOB.setBounds(757, 230, 150, 35);
        ...
        calenderBtn.setBounds(910, 228, 50, 40);
        ...
        forMobile.setBounds(985, 230, 150, 35);
        ...
        selectDocLabel.setBounds(1000, 430, 150, 35);
        ...
        labelForDate.setBounds(770, 510, 150, 35);
        ...
        calenderBtn2.setBounds(922, 510, 50, 40);
        ...
        labelForDuration.setBounds(1000, 510, 150, 35);
        ...
        textAreaScroll.setBounds(770, 590, 200, 75);

        JLabel labelForImg = new JLabel("Upload an Image");
        labelForImg.setBounds(1000, 590, 170, 35);
        ...
        fileChooser.setBounds(1150, 590, 150, 35);
    ...
    public static void LoadFromFile(ArrayList<Patient> listOfPatients, ArrayList<Consultation> listOfConsultation) throws RuntimeException, EOFException {
        try {
    ...
    private JPanel RightUpperPanel() {
        ...
        backToHomeBtn.setBounds(600, 5, 100, 50);
...
//        label.setIcon(new ImageIcon("ConsultationIcon.png"));
    ...
    private JComboBox DoctorNames() {
        ...
        comboBoxForDocName.setBounds(1150, 423, 200, 50);
    ...
    private JComboBox DoctorSpecialization() {
        ...
        comboForSpecialization.setBounds(770, 423, 200, 50);
    ...
    private JButton Book() {
        ...
        book.setBounds(1070, 690, 150, 35);
    ...
    private JComboBox TimeSlot() {
        ...
        jComboBoxForTime.setBounds(1150, 503, 200, 50);
    ...
    private JButton ListOfAppointments() {
        ...
        listOfAppointment.setBounds(720, 690, 200, 35);
    ...
    private JButton ResetButton() {
        ...
        reset.setBounds(920, 690, 150, 35);
